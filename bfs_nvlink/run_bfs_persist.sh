...
../single-GPU/tests/bfs_32 -f ../datasets/soc-LiveJournal1/soc-LiveJournal1_di.csr -o 3 -q 1 -i 50 -rounds 20
...
../single-GPU/tests/bfs_32 -f ../datasets/hollywood-2009/hollywood-2009_ud.csr -o 3 -q 1 -i 50 -rounds 20
...
../single-GPU/tests/bfs_128 -f ../datasets/indochina-2004/indochina-2004_di.csr -o 3 -q 1 -i 70 -r 40 -rounds 20
...
../single-GPU/tests/bfs_32 -f ../datasets/twitter/twitter.csr -o 3 -q 1 -i 100 -rounds 20
...
../single-GPU/tests/bfs_32 -f ../datasets/road_usa/road_usa_ud.csr -o 3 -q 1 -i 7000 -rounds 20
...
../single-GPU/tests/bfs_128 -f ../datasets/osm-eur/osm-eur.csr -o 3 -q 1 -i 51000 -rounds 20
