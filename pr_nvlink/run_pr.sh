...
../single-GPU/tests/pr_cta_discrete_32 -f ../datasets/soc-LiveJournal1/soc-LiveJournal1_di.csr -i 10 -rounds 20
...
../single-GPU/tests/pr_cta_discrete_32 -f ../datasets/hollywood-2009/hollywood-2009_ud.csr -i 10 -rounds 20
...
../single-GPU/tests/pr_cta_discrete_128 -f ../datasets/indochina-2004/indochina-2004_di.csr -i 10 -rounds 20
...
../single-GPU/tests/pr_cta_discrete_32 -f ../datasets/twitter/twitter.csr -i 200 -rounds 20
...
../single-GPU/tests/pr_cta_discrete_128 -f ../datasets/road_usa/road_usa_ud.csr -i 10 -rounds 20
...
../single-GPU/tests/pr_cta_discrete_128 -f ../datasets/osm-eur/osm-eur.csr -i 10 -rounds 20
